  ...
  <div class="panel-body">
    <div class="form-horizontal">
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-4">
		    <input type="text" class="form-control" readonly="readonly" id="add-entity-account" placeholder="" value="<?php echo $data_info['name'];?>" />    				   
	    </div>	
	  </div>
	  <div class="form-group">
	    <label for="add-entity-organization" class="col-sm-2 control-label">机构</label>
	    <div class="col-sm-4">
	        <input type="text" class="form-control" readonly="readonly" id="add-entity-organization" placeholder="" value="<?php echo $data_info['erp_fgsmc'];?>"></input>
	    </div>
	    <label for="add-entity-dept" class="col-sm-2 control-label">部门</label>
	    <div class="col-sm-4">
	        <input type="text" class="form-control" readonly="readonly" id="add-entity-dept" placeholder="" value="<?php echo $data_info['erp_bmmc'];?>"></input>
	    </div>
	  </div>
