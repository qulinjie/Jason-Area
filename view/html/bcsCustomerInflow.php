<div class="right" id="bcsCustomerInflowList">
    ...
    <?php foreach ($data['List'] as $key => $item){?>
        <div class="detail" <?php if($key%2){?>style="background:#f3f3f3;"<?php }?>>
            <span style="padding-right: 2px;"><?php if($item['TRANS_TYPE'] == 1){echo '成功';}else if($item['TRANS_TYPE'] == 2){echo '失败';}else if($item['TRANS_TYPE'] == 3){echo '状态未知';}else{echo '已冲正';} ?></span>
            <span style="padding-right: 2px;"><?php echo $item['TRANS_STATE'].'元'; ?></span>
