...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
    <div class="form-inline">
      <div class="form-group">
	    <label for="entity-search-account">用户登录帐号</label>
	    <input type="email" class="form-control" id="entity-search-account" placeholder="用户登录帐号">
	  </div>
	  <div class="form-group">
	    <label for="entity-search-nicename">用户名称</label>
	    <input type="email" class="form-control" id="entity-search-nicename" placeholder="用户名称">
	  </div>
	  <div class="form-group">
