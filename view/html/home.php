...
<div class="all">
	  <div class="t1">
      	<div class="top1">
            <div class="left"><span><a class="theme-login" href="javascript:;">登陆</a></span><span><a href="<?php echo Router::getBaseUrl()?>register/firstStep">注册</a></span></div>
      ...
      <div class="tbs">
             <div class="register"><a href="<?php echo Router::getBaseUrl()?>register/firstStep">我要注册大大付款</a></div>
